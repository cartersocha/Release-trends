...
def main(mytimer: func.TimerRequest) -> None:
    ...
    for i in range(len(df)) :
        ...
        query = ("#" + df.loc[i, "show"] + " OR " + df.loc[i, "nonHash"]) + " lang:en -is:retweet"
        ...
        for tweet, user in zip(tweets2.data, tweets2.includes['users']):
            tweet_info = {
        ...
        tweets_df_initial = pd.DataFrame(tweet_info_ls)
    ...
    local_file_name =  "tweetCollection" + ".txt"
